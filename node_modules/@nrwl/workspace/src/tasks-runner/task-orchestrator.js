...
class TaskOrchestrator {
    ...
    run(tasksInStage) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            perf_hooks_1.performance.measure('graph-creation', 'command-execution-begins', 'task-execution-begins');
            perf_hooks_1.performance.measure('nx-prep-work', 'init-local', 'task-execution-begins');
